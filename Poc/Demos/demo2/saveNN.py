...
batch_size = 1000
display_step = 1
model_path = "/home/gpudb/fraudcase/results0/demo2/results0"
...
Train_Label = np.array(h_db.parse_dynamic_response(LabelTrain)['response']['NP_FLAG'])
Test_Input = np.array(h_db.parse_dynamic_response(InputTest)['response'].values(),dtype='f')
Test_Label = np.array(h_db.parse_dynamic_response(LabelTest)['response']['NP_FLAG'])
